...
* [Example 1. Specifying a base class](Inheritance/Bases/SpecifyingBase.cs#L7-L19)
...
* [Example 34. A static virtual property in an interface](Inheritance/Virtuals/StaticVirtuals.cs#L21-L28)
* [Example 35. Invoking static virtual interface members](Inheritance/Virtuals/StaticVirtuals.cs#L7-L11)
* [Example 36. A base type with overloads distinguished only by a value type constraint](Inheritance/Virtuals/DefaultConstraints/Base.cs#L3-L7)
* [Example 37. Spelling out the effect of the `struct` constraint](Inheritance/Virtuals/DefaultConstraints/BaseWithSignaturesMadeClear.cs#L3-L7)
* [Example 38. Invoking the two methods](Inheritance/Virtuals/DefaultConstraints/DefaultConstraintInvocation.cs#L7-L22)
* [Example 39. Overriding one of two ambiguous-looking methods](Inheritance/Virtuals/DefaultConstraints/DerivedOverrideStructMethod.cs#L3-L6)
* [Example 40. Using the `default` constraint](Inheritance/Virtuals/DefaultConstraints/Derived.cs#L3-L10)


## Sealed Methods and Classes

* [Example 41. A sealed method](Inheritance/Virtuals/FixedToString.cs#L3-L9)
* [Example 42. A sealed class](Inheritance/Virtuals/EndOfTheLine.cs#L3-L5)

## Accessing Base Members

* [Example 43. Calling the base method after overriding](Inheritance/Virtuals/CallBase/CustomerDerived.cs#L5-L12)

## Inheritance and Construction

* [Example 44. No default constructor in derived class](Inheritance/Construction/Example43/Code.cs#L3-L17)
* [Example 45. Invoking a base constructor explicitly](Inheritance/Construction/Example44/Code.cs#L3-L24)
* [Example 46. Exploring construction order](Inheritance/Construction/Program.cs#L23-L51)

## Record Types

* [Example 47. Record inheritance](Inheritance/Records/Labelled.cs#L3-L10)
* [Example 48. Instantiating derived record types](Inheritance/Records/Program.cs#L3-L13)
* [Example 49. Deriving from a positional record](Inheritance/Records/Positional.cs#L3-L5)
* [Example 50. Passing a constant to a positional base record](Inheritance/Records/Positional.cs#L7)
* [Example 51. Using a derived record that has made a mandatory base property optional](Inheritance/Records/Program.cs#L20-L21)
* [Example 52. Passing positional base record arguments with an ordinary constructor](Inheritance/Records/Positional.cs#L9-L13)
* [Example 53. Making an optional base property class positional](Inheritance/Records/Positional.cs#L15-L21)
* [Example 54. Using `with` on a base record type](Inheritance/Records/Program.cs#L26-L32)
* [Example 55. Testing how `with` interacts with inheritance](Inheritance/Records/Program.cs#L34-L35)
